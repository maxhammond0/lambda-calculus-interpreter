...
/* package llang-interpreter-0.1.0.0 */
#ifndef VERSION_llang_interpreter
#define VERSION_llang_interpreter "0.1.0.0"
#endif /* VERSION_llang_interpreter */
#ifndef MIN_VERSION_llang_interpreter
#define MIN_VERSION_llang_interpreter(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_llang_interpreter */
...
#define CURRENT_COMPONENT_ID "llang-interpreter-0.1.0.0-inplace-llang-interpreter"
